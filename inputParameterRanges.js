const TemperatureRange = {
  ...
  messageHashMap.set(
    "engwarnlow",
    "is going below threshold - Warning!! Action Required!!"
  );
  messageHashMap.set("enghigh", "is high - Out of Range");
  messageHashMap.set(
    "engwarnhigh",
    "is going above threshold - Warning!! Action Required!!"
  );
  messageHashMap.set("engnormal", "is normal - In Range");
  messageHashMap.set("engSafe", "is in threshold range - Safe");
  messageHashMap.set("engNotSafe", "is not in threshold range  - Not safe");
  ...
  messageHashMap.set(
    "gerwarnlow",
    "unterschreitet den Schwellenwert - Warnung !! Handlungsbedarf!!"
  );
  messageHashMap.set("gerhigh", "ist hoch - Außerhalb der Reichweite");
  messageHashMap.set(
    "gerwarnhigh",
    "überschreitet den Schwellenwert - Warnung !! Handlungsbedarf!!"
  );
